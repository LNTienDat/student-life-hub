          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 ml-2">
              <div className="md:col-span-2">
                <label htmlFor="tkb-ten-mon" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-1.5">Tên môn học</label>
                <input
                  id="tkb-ten-mon"
                  value={tenMon}
              ...
              <div>
                <label htmlFor="tkb-thu" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-1.5">Thứ</label>
                <select
                  id="tkb-thu"
                  value={thu}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="tkb-gio-bat-dau" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-1.5">Giờ bắt đầu</label>
                  <input
                    id="tkb-gio-bat-dau"
                    type="time"
                    value={gioBatDau}
                ...
                <div>
                  <label htmlFor="tkb-gio-ket-thuc" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-1.5">Giờ kết thúc</label>
                  <input
                    id="tkb-gio-ket-thuc"
                    type="time"
                    value={gioKetThuc}
              ...
              <div>
                <label htmlFor="tkb-phong-hoc" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-1.5">Phòng học (Tùy chọn)</label>
                <input
                  id="tkb-phong-hoc"
                  value={phongHoc}
              ...
              <div>
                <label htmlFor="tkb-giang-vien" className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-1.5">Giảng viên (Tùy chọn)</label>
                <input
                  id="tkb-giang-vien"
                  value={giangVien}
                      ...
                      buoiTheoThu[t.gia].map((bh) => (
                        ...
                        >
                          ...
                          <div className="absolute top-2 right-2 flex flex-col gap-1 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-within:opacity-100 transition-opacity">
                            <button onClick={() => moFormSua(bh)} aria-label={`Sửa buổi học ${bh.tenMon}`} className="p-1 bg-white/50 hover:bg-white dark:bg-black/20 dark:hover:bg-black/40 rounded shadow-sm text-slate-700 dark:text-slate-200">
                              <Edit2 className="w-3 h-3" />
                            </button>
                            <button onClick={() => yeuCauXoa(bh)} aria-label={`Xóa buổi học ${bh.tenMon}`} className="p-1 bg-white/50 hover:bg-white dark:bg-black/20 dark:hover:bg-black/40 rounded shadow-sm text-rose-600 dark:text-rose-400">
                        ...
                        >
                          <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="flex items-center gap-2">
                              <button onClick={() => moFormSua(bh)} aria-label={`Sửa buổi học ${bh.tenMon}`} className="p-1.5 bg-white/50 dark:bg-black/20 rounded shadow-sm">
                                <Edit2 className="w-3.5 h-3.5" />
                              </button>
                              <button onClick={() => yeuCauXoa(bh)} aria-label={`Xóa buổi học ${bh.tenMon}`} className="p-1.5 bg-white/50 dark:bg-black/20 rounded shadow-sm text-rose-600 dark:text-rose-400">
